...
symbol = {
    ...
    "RIGHT_SMALL": (">", [0,0,16,24,28,24,16,0]),
    ...
    "UPANDDOWN":   ("*", [0,4,14,31,0,31,14,4]),
    "RIGHTANDLINE":(">", [8,8,8,12,14,12,8,8]),
    "RIGHTNOLINE": ("|", [8,8,8,8,8,8,8,8]),
    "QUESTIONMARK":("?", [14,17,1,6,4,0,4,31]),
    "INFO":        ("i", [4,0,12,4,4,14,0,31])
    }
