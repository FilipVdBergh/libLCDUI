...
symbol = {
    ...
    "SB_HORI_0":   (" ", [31,0,0,0,0,0,0,31]),
    "SB_HORI_25":  (".", [31,16,16,16,16,16,16,31]),
    "SB_HORI_50":  (".", [31,28,28,28,28,28,28,31]),
    "SB_HORI_75":  ("-", [31,30,30,30,30,30,30,31]),
    "SB_HORI_100": ("-", [31,31,31,31,31,31,31,31]),
    "PB_VERT_0":   (" ", [17, 17, 17, 17, 17, 17, 17, 17]),
    "PB_VERT_25":  (".", [17,17,17,17,17,17,31,17]),
    "PB_VERT_50":  (".", [17,17,17,17,31,17,17,17]),
    "PB_VERT_75":  ("|", [17,17,31,17,17,17,17,17]),
    "PB_VERT_100": ("|", [31,17,17,17,17,17,17,17]),
    "PB_HORI_0":   (" ", [31,16,16,16,16,16,16,31]),
    "PB_HORI_25":  (".", [31,8,8,8,8,8,8,31]),
    "PB_HORI_50":  (".", [31,4,4,4,4,4,4,31]),
    "PB_HORI_75":  ("-", [31,2,2,2,2,2,2,31]),
    "PB_HORI_100": ("-", [31,1,1,1,1,1,1,31]),
